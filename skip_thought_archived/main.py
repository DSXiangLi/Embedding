...
from skip_thought_archived.dataset import SkipThoughtDataset
...
def main(args):
    ...
    model_fn = getattr( importlib.import_module('skip_thought_archived.model'), '{}_model'.format(args.model))
...
if __name__ == '__main__':
    ...
    parser.add_argument( '--model', type = str, help = 'models: [skip_thought_archived|quick_thought]',
                         required=False, default='skip_thought_archived')
